...
public class AndroidAdapter extends ArrayAdapter<com.example.sorianojericholabexer4.AndroidVersion> {
    ...
    public View getView(int i, @Nullable View convertView, ViewGroup parent) {
        ...
        TextView comName = convertView.findViewById(R.id.tbIndustry);
        TextView country = convertView.findViewById(R.id.tbIndustry);
        TextView industry= convertView.findViewById(R.id.tbIndustry);
        TextView ceo = convertView.findViewById(R.id.tbCEO);
